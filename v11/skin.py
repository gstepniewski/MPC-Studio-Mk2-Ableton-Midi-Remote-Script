...
class Colors:
    ...
    class Macro:
        ...
        EqOff = MPCPadColor(color=RGBColorDef.GREEN, brightness=80)
        EqOn = MPCPadColor(color=RGBColorDef.GREEN, brightness=5)
        AutofilterOff = MPCPadColor(color=RGBColorDef.RED, brightness=80)
        AutofilterOn = MPCPadColor(color=RGBColorDef.RED, brightness=5)
        GateOff = MPCPadColor(color=RGBColorDef.PEACH, brightness=80)
        GateOn = MPCPadColor(color=RGBColorDef.PEACH, brightness=5)
        LfoOff = MPCPadColor(color=RGBColorDef.YELLOW, brightness=80)
        LfoOn = MPCPadColor(color=RGBColorDef.YELLOW, brightness=5)
        Eq8Off = MPCPadColor(color=RGBColorDef.GREEN, brightness=80)
        Eq8On = MPCPadColor(color=RGBColorDef.GREEN, brightness=5)
        UtilityOff = MPCPadColor(color=RGBColorDef.WHITE, brightness=80)
        UtilityOn = MPCPadColor(color=RGBColorDef.WHITE, brightness=5)
        LimiterOff = MPCPadColor(color=RGBColorDef.PINK, brightness=80)
        LimiterOn = MPCPadColor(color=RGBColorDef.PINK, brightness=5)
