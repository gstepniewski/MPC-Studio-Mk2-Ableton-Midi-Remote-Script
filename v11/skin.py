...
class Colors:
    ...
    class Action:
        ...
        Off = TwoColorButtonMap.COLOR_1_FULL
    class Macro:
        AudioOff = MPCPadColor(color=RGBColorDef.BLUE, brightness=80)
        AudioOn = MPCPadColor(color=RGBColorDef.BLUE, brightness=5)
        MidiOff = MPCPadColor(color=RGBColorDef.ORANGE, brightness=80)
        MidiOn = MPCPadColor(color=RGBColorDef.ORANGE, brightness=5)
        DrumRackOff = MPCPadColor(color=RGBColorDef.YELLOW, brightness=80)
        DrumRackOn = MPCPadColor(color=RGBColorDef.YELLOW, brightness=5)
        SimplerOff = MPCPadColor(color=RGBColorDef.TEAL, brightness=80)
        SimplerOn = MPCPadColor(color=RGBColorDef.TEAL, brightness=5)
        CompressorOff = MPCPadColor(color=RGBColorDef.PURPLE, brightness=80)
        CompressorOn = MPCPadColor(color=RGBColorDef.PURPLE, brightness=5)
        DelayOff = MPCPadColor(color=RGBColorDef.PURPLE, brightness=80)
        DelayOn = MPCPadColor(color=RGBColorDef.PURPLE, brightness=5)
        AutofilterOff = MPCPadColor(color=RGBColorDef.PURPLE, brightness=80)
        AutofilterOn = MPCPadColor(color=RGBColorDef.PURPLE, brightness=5)
        TunerOff = MPCPadColor(color=RGBColorDef.GREEN, brightness=80)
        TunerOn = MPCPadColor(color=RGBColorDef.GREEN, brightness=5)
        ReverbOff = MPCPadColor(color=RGBColorDef.PURPLE, brightness=80)
        ReverbOn = MPCPadColor(color=RGBColorDef.PURPLE, brightness=5)
        Eq8Off = MPCPadColor(color=RGBColorDef.GREEN, brightness=80)
        Eq8On = MPCPadColor(color=RGBColorDef.GREEN, brightness=5)
        UtilityOff = MPCPadColor(color=RGBColorDef.GREEN, brightness=80)
        UtilityOn = MPCPadColor(color=RGBColorDef.GREEN, brightness=5)
        LimiterOff = MPCPadColor(color=RGBColorDef.GREEN, brightness=80)
        LimiterOn = MPCPadColor(color=RGBColorDef.GREEN, brightness=5)
        DeleteTrackOff = MPCPadColor(color=RGBColorDef.RED, brightness=80)
        DeleteTrackOn = MPCPadColor(color=RGBColorDef.RED, brightness=5)
        DeleteDeviceOff = MPCPadColor(color=RGBColorDef.RED, brightness=80)
        DeleteDeviceOn = MPCPadColor(color=RGBColorDef.RED, brightness=5)
        DuplicateTrackOff = MPCPadColor(color=RGBColorDef.INDIGO, brightness=80)
        DuplicateTrackOn = MPCPadColor(color=RGBColorDef.INDIGO, brightness=5)
        DuplicateSceneOff = MPCPadColor(color=RGBColorDef.PEACH, brightness=80)
        DuplicateSceneOn = MPCPadColor(color=RGBColorDef.PEACH, brightness=5)
    class Quantization:
        On = TwoColorButtonMap.COLOR_1_FULL
